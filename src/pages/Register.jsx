...
function Register() {
  ...
  return (
    <>
      <div className='font-custom flex items-center justify-between px-6 md:px-[200px] py-4'>
          ...
          <div className="text-white">
            ...
            <form action="#">
              <div className="mb-4 text-lg">
                <input onChange={(e) => setUsername(e.target.value)} className="rounded-3xl border-none bg-stone-300 bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md" type="text" placeholder="Enter Your User Name" />
              </div>
              <div className="mb-4 text-lg">
              ...
              <div className="mt-8 flex justify-center text-lg text-black">
                <button onClick={handleRegister} className="rounded-3xl bg--400 bg-opacity-50 px-10 py-2 bg-cyan-400 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-600">Register</button>
